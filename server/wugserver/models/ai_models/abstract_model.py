...
class AIModel(object):
  ...
  def post_message(self, api_key: Any, interaction_context: Any, message_create_params: MessageCreate):
    """
  ...
  def get_interaction_context(self, db: Session, interaction: InteractionModel) -> Any:
